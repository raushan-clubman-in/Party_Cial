...
Public Class FOODOERDERREPORT
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "partymodule.FOODOERDERREPORT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFOODOERDERREPORT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FOODOERDERREPORT = New FOODOERDERREPORT()
        rpt.Site = Me.Site
        Return rpt
    End Function
