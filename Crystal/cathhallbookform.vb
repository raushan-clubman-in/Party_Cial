...
Public Class cathhallbookform
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "partymodule.cathhallbookform.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcathhallbookform
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cathhallbookform = New cathhallbookform()
        rpt.Site = Me.Site
        Return rpt
    End Function
