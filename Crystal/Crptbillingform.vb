...
Public Class Crptbillingform
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "partymodule.Crptbillingform.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrptbillingform
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crptbillingform = New Crptbillingform()
        rpt.Site = Me.Site
        Return rpt
    End Function
