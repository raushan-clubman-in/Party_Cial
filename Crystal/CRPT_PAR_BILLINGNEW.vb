...
Public Class CRPT_PAR_BILLINGNEW
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRPT_PAR_BILLINGNEW.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "partymodule.CRPT_PAR_BILLINGNEW.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRPT_PAR_BILLINGNEW
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRPT_PAR_BILLINGNEW = New CRPT_PAR_BILLINGNEW()
        rpt.Site = Me.Site
        Return rpt
    End Function
