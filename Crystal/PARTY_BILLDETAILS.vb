...
Public Class PARTY_BILLDETAILS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "partymodule.PARTY_BILLDETAILS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPARTY_BILLDETAILS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PARTY_BILLDETAILS = New PARTY_BILLDETAILS()
        rpt.Site = Me.Site
        Return rpt
    End Function
