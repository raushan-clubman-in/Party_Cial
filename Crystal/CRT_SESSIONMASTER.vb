...
Public Class CRT_SESSIONMASTER
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "partymodule.CRT_SESSIONMASTER.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRT_SESSIONMASTER
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRT_SESSIONMASTER = New CRT_SESSIONMASTER()
        rpt.Site = Me.Site
        Return rpt
    End Function
