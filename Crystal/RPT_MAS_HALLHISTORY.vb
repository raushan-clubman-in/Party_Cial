...
Public Class RPT_MAS_HALLHISTORY
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RPT_MAS_HALLHISTORY.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "partymodule.RPT_MAS_HALLHISTORY.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_MAS_HALLHISTORY
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_MAS_HALLHISTORY = New RPT_MAS_HALLHISTORY()
        rpt.Site = Me.Site
        Return rpt
    End Function
