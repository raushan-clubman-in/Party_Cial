...
Public Class CrptPARTY_VIEW_ADDTION
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "CrptPARTY_VIEW_ADDTION.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrptPARTY_VIEW_ADDTION
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrptPARTY_VIEW_ADDTION = New CrptPARTY_VIEW_ADDTION
        rpt.Site = Me.Site
        Return rpt
    End Function
