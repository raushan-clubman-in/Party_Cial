...
Public Class RPT_MAS_UOMHISTORY
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "partymodule.RPT_MAS_UOMHISTORY.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_MAS_UOMHISTORY
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_MAS_UOMHISTORY = New RPT_MAS_UOMHISTORY()
        rpt.Site = Me.Site
        Return rpt
    End Function
