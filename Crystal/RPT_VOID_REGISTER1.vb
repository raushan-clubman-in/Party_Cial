...
Public Class RPT_VOID_REGISTER1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "partymodule.RPT_VOID_REGISTER1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_VOID_REGISTER1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_VOID_REGISTER1 = New RPT_VOID_REGISTER1()
        rpt.Site = Me.Site
        Return rpt
    End Function
