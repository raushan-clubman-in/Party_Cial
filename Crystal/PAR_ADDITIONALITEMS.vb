...
Public Class PAR_ADDITIONALITEMS
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "PAR_ADDITIONALITEMS.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "partymodule.PAR_ADDITIONALITEMS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPAR_ADDITIONALITEMS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PAR_ADDITIONALITEMS = New PAR_ADDITIONALITEMS()
        rpt.Site = Me.Site
        Return rpt
    End Function
