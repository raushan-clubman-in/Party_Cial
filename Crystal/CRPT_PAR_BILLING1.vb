...
Public Class CRPT_PAR_BILLING1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "partymodule.CRPT_PAR_BILLING1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRPT_PAR_BILLING1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRPT_PAR_BILLING1 = New CRPT_PAR_BILLING1()
        rpt.Site = Me.Site
        Return rpt
    End Function
