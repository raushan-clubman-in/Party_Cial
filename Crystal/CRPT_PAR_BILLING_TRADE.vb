...
Public Class CRPT_PAR_BILLING_TRADE
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRPT_PAR_BILLING_TRADE.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "partymodule.CRPT_PAR_BILLING_TRADE.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRPT_PAR_BILLING_TRADE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRPT_PAR_BILLING_TRADE = New CRPT_PAR_BILLING_TRADE()
        rpt.Site = Me.Site
        Return rpt
    End Function
