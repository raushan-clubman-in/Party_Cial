...
Public Class RPT_BOOKING_itemwise
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RPT_BOOKING_itemwise.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "partymodule.RPT_BOOKING_itemwise.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_BOOKING_itemwise
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_BOOKING_itemwise = New RPT_BOOKING_itemwise()
        rpt.Site = Me.Site
        Return rpt
    End Function
