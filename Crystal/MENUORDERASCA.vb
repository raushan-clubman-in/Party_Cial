...
Public Class MENUORDERASCA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "partymodule.MENUORDERASCA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMENUORDERASCA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MENUORDERASCA = New MENUORDERASCA()
        rpt.Site = Me.Site
        Return rpt
    End Function
