...
Public Class cateringbillreport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "partymodule.cateringbillreport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcateringbillreport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cateringbillreport = New cateringbillreport()
        rpt.Site = Me.Site
        Return rpt
    End Function
