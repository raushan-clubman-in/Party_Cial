...
Public Class PARTY_MAINTAIN
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "partymodule.PARTY_MAINTAIN.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPARTY_MAINTAIN
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PARTY_MAINTAIN = New PARTY_MAINTAIN()
        rpt.Site = Me.Site
        Return rpt
    End Function
