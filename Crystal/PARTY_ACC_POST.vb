...
Public Class PARTY_ACC_POST
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "partymodule.PARTY_ACC_POST.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPARTY_ACC_POST
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PARTY_ACC_POST = New PARTY_ACC_POST()
        rpt.Site = Me.Site
        Return rpt
    End Function
