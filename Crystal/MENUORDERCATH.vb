...
Public Class MENUORDERCATH
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "partymodule.MENUORDERCATH.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMENUORDERCATH
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MENUORDERCATH = New MENUORDERCATH()
        rpt.Site = Me.Site
        Return rpt
    End Function
