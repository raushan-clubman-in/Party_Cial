...
Public Class MAINTAINANCEA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "partymodule.MAINTAINANCEA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMAINTAINANCEA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MAINTAINANCEA = New MAINTAINANCEA()
        rpt.Site = Me.Site
        Return rpt
    End Function
