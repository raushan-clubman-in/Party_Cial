...
Public Class CRPT_PAR_BILLING_Cancel
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRPT_PAR_BILLING_Cancel.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "partymodule.CRPT_PAR_BILLING_Cancel.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRPT_PAR_BILLING_Cancel
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRPT_PAR_BILLING_Cancel = New CRPT_PAR_BILLING_Cancel()
        rpt.Site = Me.Site
        Return rpt
    End Function
