...
Public Class PENDINGBILL_GUST
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "partymodule.PENDINGBILL_GUST.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPENDINGBILL_GUST
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PENDINGBILL_GUST = New PENDINGBILL_GUST()
        rpt.Site = Me.Site
        Return rpt
    End Function
