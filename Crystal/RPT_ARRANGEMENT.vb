...
Public Class RPT_ARRANGEMENT
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "partymodule.RPT_ARRANGEMENT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_ARRANGEMENT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_ARRANGEMENT = New RPT_ARRANGEMENT()
        rpt.Site = Me.Site
        Return rpt
    End Function
