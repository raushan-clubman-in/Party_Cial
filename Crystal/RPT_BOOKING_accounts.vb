...
Public Class RPT_BOOKING_accounts
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RPT_BOOKING_accounts.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "partymodule.RPT_BOOKING_accounts.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_BOOKING_accounts
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_BOOKING_accounts = New RPT_BOOKING_accounts()
        rpt.Site = Me.Site
        Return rpt
    End Function
