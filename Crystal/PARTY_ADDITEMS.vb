...
Public Class PARTY_ADDITEMS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "partymodule.PARTY_ADDITEMS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPARTY_ADDITEMS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PARTY_ADDITEMS = New PARTY_ADDITEMS()
        rpt.Site = Me.Site
        Return rpt
    End Function
