...
Public Class Crpt_CancelDetail
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "partymodule.Crpt_CancelDetail.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrpt_CancelDetail
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crpt_CancelDetail = New Crpt_CancelDetail()
        rpt.Site = Me.Site
        Return rpt
    End Function
