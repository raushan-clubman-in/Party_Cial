...
Public Class party_ITEMWISE
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "partymodule.party_ITEMWISE.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedparty_ITEMWISE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As party_ITEMWISE = New party_ITEMWISE()
        rpt.Site = Me.Site
        Return rpt
    End Function
