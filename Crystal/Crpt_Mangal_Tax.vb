...
Public Class Crpt_Mangal_Tax
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "partymodule.Crpt_Mangal_Tax.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrpt_Mangal_Tax
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crpt_Mangal_Tax = New Crpt_Mangal_Tax()
        rpt.Site = Me.Site
        Return rpt
    End Function
