...
Public Class PARTYVIEWBOOKING
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "partymodule.PARTYVIEWBOOKING.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPARTYVIEWBOOKING
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PARTYVIEWBOOKING = New PARTYVIEWBOOKING()
        rpt.Site = Me.Site
        Return rpt
    End Function
