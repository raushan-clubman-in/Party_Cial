...
Public Class FRM_MKGA_Subgroupmaster
    ...
    Private Sub Txt_subgroup_Validated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Txt_subgroup.Validated
        If Trim(Txt_subgroup.Text) <> "" Then
            sqlstring = "SELECT * FROM subGroupMaster WHERE subGroupCode= '" & Trim(Replace(Txt_subgroup.Text, "'", "")) & "' "
            gconnection.getDataSet(sqlstring, "subGroupMaster")
            If gdataset.Tables("subGroupMaster").Rows.Count > 0 Then
                Txtsubdesc.Clear()
                Txtsubdesc.Text = Replace(Trim(gdataset.Tables("subGroupMaster").Rows(0).Item("subGroupdesc")), "", "'")
                txtSname.Text = Replace(Trim(gdataset.Tables("subGroupMaster").Rows(0).Item("shortname")), "", "'")
                txtGroupCode.Text = Replace(Trim(gdataset.Tables("subGroupMaster").Rows(0).Item("groupcode")), "", "'")
                txtGroupDesc.Text = Replace(Trim(gdataset.Tables("subGroupMaster").Rows(0).Item("Groupdesc")), "", "'")
    ...
    Private Sub Cmd_Freeze_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_Freeze.Click
        ...
        If Mid(Me.Cmd_Freeze.Text, 1, 1) = "F" Then
            ...
            If status = 1 Then
                ...
                sqlstring = sqlstring & " WHERE subGroupcode = '" & Trim(Replace(Txt_subgroup.Text, "'", "")) & "'"
        ...
        If mm = 1 Then
            ...
            If gdataset.Tables("UOMMASTER").Rows.Count > 0 Then
                For i = 0 To gdataset.Tables("UOMMASTER").Rows.Count - 1
                    ...
                    Sqlstring = "UPDATE UOMMASTER SET UOMSEQNO  = " & (vseqno) & " WHERE UOMCODE = '" & Trim(Replace(gdataset.Tables("UOMMASTER").Rows(i).Item("UOMCODE"), "'", "")) & "'"
    ...
    Private Sub Cmdbrse_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmdbrse.Click
        ...
        Call VIEW1.LOADGRID(gdataset.Tables("MENUMASTER"), True, "", "SELECT * FROM SUBGROUPMASTER", "GROUPCODE", 1, Me.Txt_subgroup)
    ...
    Private Sub Txtsubdesc_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Txtsubdesc.TextChanged

    End Sub

    Private Sub Txt_subgroup_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Txt_subgroup.TextChanged
    ...
    Private Sub FRM_MKGA_Subgroupmaster_Resize(sender As Object, e As EventArgs) Handles Me.Resize
        rs.ResizeAllControls(Me)
    End Sub
End Class