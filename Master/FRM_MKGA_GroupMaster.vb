...
Public Class FRM_MKGA_GroupMaster
    ...
    Private Sub txtGroupCode_Validated(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtGroupCode.Validated
        If Trim(txtGroupCode.Text) <> "" Then
            sqlstring = "SELECT * FROM GroupMaster WHERE GroupCode= '" & Trim(Replace(txtGroupCode.Text, "'", "")) & "'"
            gconnection.getDataSet(sqlstring, "GroupMaster")
            If gdataset.Tables("GroupMaster").Rows.Count > 0 Then
                txtGroupDesc.Clear()
                txtSname.Clear()
                txtGroupDesc.Text = Replace(Trim(gdataset.Tables("GroupMaster").Rows(0).Item("Groupdesc")), "", "'")
                txtSname.Text = Replace(Trim(gdataset.Tables("GroupMaster").Rows(0).Item("ShortName")), "", "'")

                CBO_CATEGORY.DropDownStyle = ComboBoxStyle.DropDown
                CBO_CATEGORY.Text = Replace(Trim(gdataset.Tables("GroupMaster").Rows(0).Item("Category")), "", "'")
    ...
    Private Sub Cmd_Add_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_Add.Click
        ...
        If Cmd_Add.Text = "Add [F7]" Then
            ...
            strSQL = strSQL & " VALUES ( '" & Trim(Replace(txtGroupCode.Text, "", "'")) & "'," & Val(vseqno) & ",'" & Replace(Trim(txtGroupDesc.Text), "'", "") & "',"
    ...
    Private Sub Cmd_Freeze_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_Freeze.Click
        ...
        If Mid(Me.Cmd_Freeze.Text, 1, 1) = "F" Then
            ...
            If STATUS = 1 Then
                ...
                sqlstring = sqlstring & " WHERE Groupcode = '" & Trim(Replace(txtGroupCode.Text, "'", "")) & "'"
    ...
    Private Sub Cmdbrse_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmdbrse.Click
        ...
        Call VIEW1.LOADGRID(gdataset.Tables("MENUMASTER"), True, "", "SELECT * FROM GROUPMASTER", "GROUPCODE", 1, Me.txtGroupCode)
    ...
    Private Sub FRM_MKGA_GroupMaster_Resize(sender As Object, e As EventArgs) Handles Me.Resize
        rs.ResizeAllControls(Me)
    End Sub
End Class