...
Imports System.IO
Public Class PTY_CATEGORYMASTER
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(PTY_CATEGORYMASTER))
        ...
        Me.lbl_freeze.Location = New System.Drawing.Point(360, 296)
        ...
        Me.grp_StatusConversion4.Location = New System.Drawing.Point(88, 328)
        Me.grp_StatusConversion4.Name = "grp_StatusConversion4"
        Me.grp_StatusConversion4.Size = New System.Drawing.Size(672, 64)
        ...
        Me.cmdexport.Location = New System.Drawing.Point(424, 16)
        ...
        Me.CMD_PRINT.Location = New System.Drawing.Point(864, 240)
        ...
        Me.cmd_View.Location = New System.Drawing.Point(744, 240)
        ...
        Me.CMD_Ccode.Location = New System.Drawing.Point(368, 16)
        ...
        Me.txt_CCode.Location = New System.Drawing.Point(200, 16)
        Me.txt_CCode.Name = "txt_CCode"
        Me.txt_CCode.Size = New System.Drawing.Size(168, 21)
        ...
        Me.Txt_Cdesc.Location = New System.Drawing.Point(200, 56)
        Me.Txt_Cdesc.MaxLength = 50
        Me.Txt_Cdesc.Name = "Txt_Cdesc"
        Me.Txt_Cdesc.Size = New System.Drawing.Size(192, 21)
        ...
        Me.lbl_Caption.Location = New System.Drawing.Point(328, 24)
        Me.lbl_Caption.Name = "lbl_Caption"
        Me.lbl_Caption.Size = New System.Drawing.Size(260, 31)
        Me.lbl_Caption.TabIndex = 425
        Me.lbl_Caption.Text = "CATEGORY MASTER"
        Me.lbl_Caption.TextAlign = System.Drawing.ContentAlignment.MiddleCenter
        '
        'GroupBox1
        '
        Me.GroupBox1.BackColor = System.Drawing.Color.Transparent
        Me.GroupBox1.Controls.Add(Me.Txt_Cdesc)
        ...
        Me.Grp_Print.Location = New System.Drawing.Point(264, 224)
        Me.Grp_Print.Name = "Grp_Print"
        Me.Grp_Print.Size = New System.Drawing.Size(368, 56)
        Me.Grp_Print.TabIndex = 660
        ...
        Me.ClientSize = New System.Drawing.Size(888, 406)
...
#End Region
    ...
    Private Sub cmd_Add_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_Add.Click
        ...
        If Mid(cmd_Add.Text, 1, 1) = "A" Then
            sqlstring = "INSERT INTO PARTY_CATEGORYMASTER (ccode,cdesc,freeze,adduser,adddate) VALUES("
            sqlstring = sqlstring & " '" & Trim(txt_CCode.Text) & "','" & Trim(Txt_Cdesc.Text) & "','N',"
        ...
        ElseIf Mid(cmd_Add.Text, 1, 1) = "U" Then
            If lbl_freeze.Visible = True Then
                ...
                Exit Sub
            End If
            sqlstring = "UPDATE PARTY_CATEGORYMASTER SET CDESC='" & Trim(Txt_Cdesc.Text) & "',FREEZE='N',"
            sqlstring = sqlstring & " ADDUSER='" & Trim(gUsername) & "',ADDDATE='" & Format(DateTime.Now, "dd/MMM/yyyy") & "' "
            sqlstring = sqlstring & " WHERE CCODE='" & Trim(txt_CCode.Text) & "'"
    ...
    Private Sub cmd_Freeze_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_Freeze.Click
        ...
        If Mid(cmd_Freeze.Text, 1, 1) = "F" Then
            sqlstring = "SELECT ISNULL(CCODE,'')AS CCODE,ISNULL(CDESC,'')AS CDESC FROM PARTY_CATEGORYMASTER"
            sqlstring = sqlstring & " WHERE ISNULL(CCODE,'')='" & Trim(txt_CCode.Text) & "'"
            gconn.getDataSet(sqlstring, "GRP1")
            If gdataset.Tables("GRP1").Rows.Count > 0 Then
                sqlstring = "UPDATE PARTY_CATEGORYMASTER SET FREEZE='Y',"
                sqlstring = sqlstring & " ADDUSER='" & Trim(gUsername) & "',ADDDATE='" & Format(DateTime.Now, "dd/MMM/yyyy") & "' "
                sqlstring = sqlstring & " WHERE CCODE='" & Trim(txt_CCode.Text) & "'"
        ...
        If Mid(cmd_Freeze.Text, 1, 1) = "U" Then
            sqlstring = "UPDATE PARTY_CATEGORYMASTER SET FREEZE='N',"
            sqlstring = sqlstring & " ADDUSER='" & Trim(gUsername) & "',ADDDATE='" & Format(DateTime.Now, "dd/MMM/yyyy") & "' "
            sqlstring = sqlstring & " WHERE CCODE='" & Trim(txt_CCode.Text) & "'"
    ...
    Private Sub cmd_View_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_View.Click
        ...
        'tables = " FROM party_categorymaster"
        'Gheader = "CATEGORY MASTER"
        'FrReport.SsGridReport.SetText(2, 1, "CCODE")
        'FrReport.SsGridReport.SetText(3, 1, 10)
        'FrReport.SsGridReport.SetText(2, 2, "CDESC")
    ...
    Private Sub txt_CCode_Validated(ByVal sender As Object, ByVal e As System.EventArgs) Handles txt_CCode.Validated
        If Trim(txt_CCode.Text) <> "" Then
            sqlstring = "SELECT ISNULL(CCODE,'')AS CCODE,ISNULL(CDESC,'')AS CDESC,ISNULL(FREEZE,'')AS FREEZE FROM PARTY_CATEGORYMASTER"
            sqlstring = sqlstring & " WHERE ISNULL(CCODE,'')='" & Trim(txt_CCode.Text) & "'"
            gconn.getDataSet(sqlstring, "GRP")
            If gdataset.Tables("GRP").Rows.Count > 0 Then
                cmd_Add.Text = "Update[F7]"
                txt_CCode.Text = gdataset.Tables("GRP").Rows(0).Item("CCODE")
                Txt_Cdesc.Text = gdataset.Tables("GRP").Rows(0).Item("CDESC")
    ...
    Private Sub txt_CCode_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txt_CCode.KeyPress
        ...
        End If
    End Sub
    Private Sub PTY_CATEGORYMASTER_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub Txt_Cdesc_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Txt_Cdesc.KeyPress
        ...
        End If
    End Sub
    Private Sub PTY_CATEGORYMASTER_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub CMD_WINDOWS_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CMD_WINDOWS.Click
        ...
        Dim STR As String
        Dim r As New RPT_MAS_CATEGORYHISTORY
        STR = "SELECT * FROM VIEW_PARTY_CATEGORYHISTORY"
        Viewer.ssql = STR
        Viewer.Report = r
        Viewer.TableName = "VIEW_PARTY_CATEGORYHISTORY"
    ...
    Private Function PrintHeader(ByVal HEADING As String, ByVal MSKFROMDATE As Date, ByVal MSKTODATE As Date)
        ...
        Try
            ...
            pagesize = pagesize + 1
            Filewrite.WriteLine("SNO CATCODE   CATEGORY DESCRIPTION  FREEZE ADDUSER         ADDDATETIME")
            pagesize = pagesize + 1
            Filewrite.WriteLine(StrDup(79, "-"))
            pagesize = pagesize + 1
        ...
        Try
            ...
            If gdataset.Tables("roomcompanymasterhistory").Rows.Count > 0 Then
                ...
                For Each dr In gdataset.Tables("roomcompanymasterhistory").Rows
                    ...
                    SSQL = SSQL & Space(1) & Mid(Format(dr("CDESC"), ""), 1, 25) & Space(25 - Len(Mid(Format(dr("CDESC"), ""), 1, 25)))
