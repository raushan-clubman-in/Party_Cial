Public Class LIST_OPERATION1
    ...
    Friend vFormatstring As String
    Friend KeyPos1 As Integer
    Friend KeyPos As Integer

    ' ''Property vFormatstring As String

    ' ''Property KeyPos1 As Integer

    ' ''Property KeyPos As Integer
    ...
    Private Sub LIST_OPERATION1_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
    ...
    Private Sub DataGridView1_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView1.CellClick
        If DataGridView1.Rows.Count > 0 Then
            ...
            ElseIf DataGridView1.ColumnCount = 8 Then
                keyfield = DataGridView1.Rows(e.RowIndex).Cells(0).Value().ToString()
                keyfield1 = DataGridView1.Rows(e.RowIndex).Cells(1).Value().ToString()
                keyfield2 = DataGridView1.Rows(e.RowIndex).Cells(2).Value().ToString()
                keyfield3 = DataGridView1.Rows(e.RowIndex).Cells(3).Value().ToString()
            ...
            ElseIf DataGridView1.ColumnCount = 12 Then
                keyfield = DataGridView1.Rows(e.RowIndex).Cells(0).Value().ToString()
                keyfield1 = DataGridView1.Rows(e.RowIndex).Cells(1).Value().ToString()
                keyfield2 = DataGridView1.Rows(e.RowIndex).Cells(2).Value().ToString()
                keyfield3 = DataGridView1.Rows(e.RowIndex).Cells(3).Value().ToString()
                ...
                keyfield9 = DataGridView1.Rows(e.RowIndex).Cells(9).Value().ToString()
                keyfield10 = DataGridView1.Rows(e.RowIndex).Cells(10).Value().ToString()
                keyfield11 = DataGridView1.Rows(e.RowIndex).Cells(11).Value().ToString()
            ElseIf DataGridView1.ColumnCount = 13 Then
                keyfield = DataGridView1.Rows(e.RowIndex).Cells(0).Value().ToString()
                keyfield1 = DataGridView1.Rows(e.RowIndex).Cells(1).Value().ToString()
                keyfield2 = DataGridView1.Rows(e.RowIndex).Cells(2).Value().ToString()
                keyfield3 = DataGridView1.Rows(e.RowIndex).Cells(3).Value().ToString()
                ...
                keyfield10 = DataGridView1.Rows(e.RowIndex).Cells(10).Value().ToString()
                keyfield11 = DataGridView1.Rows(e.RowIndex).Cells(11).Value().ToString()
                keyfield12 = DataGridView1.Rows(e.RowIndex).Cells(12).Value().ToString()
            ElseIf DataGridView1.ColumnCount = 14 Then
                keyfield = DataGridView1.Rows(e.RowIndex).Cells(0).Value().ToString()
                keyfield1 = DataGridView1.Rows(e.RowIndex).Cells(1).Value().ToString()
                keyfield2 = DataGridView1.Rows(e.RowIndex).Cells(2).Value().ToString()
                keyfield3 = DataGridView1.Rows(e.RowIndex).Cells(3).Value().ToString()
                ...
                keyfield11 = DataGridView1.Rows(e.RowIndex).Cells(11).Value().ToString()
                keyfield12 = DataGridView1.Rows(e.RowIndex).Cells(12).Value().ToString()
                keyfield13 = DataGridView1.Rows(e.RowIndex).Cells(13).Value().ToString()
            ElseIf DataGridView1.ColumnCount = 15 Then
                keyfield = DataGridView1.Rows(e.RowIndex).Cells(0).Value().ToString()
                keyfield1 = DataGridView1.Rows(e.RowIndex).Cells(1).Value().ToString()
                keyfield2 = DataGridView1.Rows(e.RowIndex).Cells(2).Value().ToString()
                keyfield3 = DataGridView1.Rows(e.RowIndex).Cells(3).Value().ToString()
                ...
                keyfield12 = DataGridView1.Rows(e.RowIndex).Cells(12).Value().ToString()
                keyfield13 = DataGridView1.Rows(e.RowIndex).Cells(13).Value().ToString()
                keyfield14 = DataGridView1.Rows(e.RowIndex).Cells(14).Value().ToString()
            End If
        ...
        If DataGridView1.Rows.Count > 0 Then
            If e.KeyChar = ChrW(Keys.Enter) Then
                ...
                ElseIf DataGridView1.ColumnCount = 12 Then
                    ...
                    keyfield9 = DataGridView1.Rows(row).Cells(9).Value.ToString()
                    keyfield10 = DataGridView1.Rows(row).Cells(10).Value.ToString()
                    keyfield11 = DataGridView1.Rows(row).Cells(11).Value.ToString()
                ElseIf DataGridView1.ColumnCount = 13 Then
                    keyfield = DataGridView1.Rows(row).Cells(0).Value.ToString()
                    keyfield1 = DataGridView1.Rows(row).Cells(1).Value.ToString()
                    keyfield2 = DataGridView1.Rows(row).Cells(2).Value.ToString()
                    ...
                    keyfield10 = DataGridView1.Rows(row).Cells(10).Value.ToString()
                    keyfield11 = DataGridView1.Rows(row).Cells(11).Value.ToString()
                    keyfield12 = DataGridView1.Rows(row).Cells(12).Value.ToString()
                ElseIf DataGridView1.ColumnCount = 14 Then
                    keyfield = DataGridView1.Rows(row).Cells(0).Value.ToString()
                    keyfield1 = DataGridView1.Rows(row).Cells(1).Value.ToString()
                    keyfield2 = DataGridView1.Rows(row).Cells(2).Value.ToString()
                    ...
                    keyfield11 = DataGridView1.Rows(row).Cells(11).Value.ToString()
                    keyfield12 = DataGridView1.Rows(row).Cells(12).Value.ToString()
                    keyfield13 = DataGridView1.Rows(row).Cells(13).Value.ToString()
                ElseIf DataGridView1.ColumnCount = 15 Then
                    keyfield = DataGridView1.Rows(row).Cells(0).Value.ToString()
                    keyfield1 = DataGridView1.Rows(row).Cells(1).Value.ToString()
                    keyfield2 = DataGridView1.Rows(row).Cells(2).Value.ToString()
                    ...
                    keyfield12 = DataGridView1.Rows(row).Cells(12).Value.ToString()
                    keyfield13 = DataGridView1.Rows(row).Cells(13).Value.ToString()
                    keyfield14 = DataGridView1.Rows(row).Cells(14).Value.ToString()
                End If
                Me.Hide()
            End If
        End If
