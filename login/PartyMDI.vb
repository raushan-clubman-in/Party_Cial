...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.menu_Master.MenuItems.AddRange(New System.Windows.Forms.MenuItem() {Me.MenuItem18, Me.submnu_MemberCategory, Me.MenuItem19, Me.submnu_MemberCorporate, Me.submenu_uommaster, Me.MenuItem24, Me.MenuItem25, Me.submnu_MemberMaster, Me.MenuItem22, Me.MenuItem32, Me.MenuItem6, Me.MenuItem33, Me.submnu_MemberSubscription, Me.MenuItem36, Me.MenuItem21, Me.MenuItem20, Me.MenuItem41, Me.MenuItem42, Me.MenuItem45, Me.MenuItem46, Me.MenuItem47})
        ...
        Me.submnu_MemberMaster.Text = "Banquet Arrangement Item Master"
        '
        'MenuItem22
        '
        Me.MenuItem22.Index = 8
        Me.MenuItem22.Shortcut = System.Windows.Forms.Shortcut.CtrlL
        Me.MenuItem22.Text = "Banquet Cancellation Master"
        '
        'MenuItem32
        '
        ...
        Me.MenuItem20.Text = " Location Master"
        '
        'MenuItem41
        '
        Me.MenuItem41.Index = 16
        Me.MenuItem41.Text = "Banquet Setup"
        Me.MenuItem41.Visible = False
        '
        'MenuItem42
        '
        Me.MenuItem42.Index = 17
        Me.MenuItem42.Text = "Banquet Tax Type Master"
        '
        'MenuItem45
        '
        Me.MenuItem45.Index = 18
        Me.MenuItem45.Text = "Banquet HoliDay Master"
        '
        'MenuItem46
        '
        Me.MenuItem46.Index = 19
        Me.MenuItem46.Text = "Banquet Purpose Master"
        '
        'MenuItem47
        '
        Me.MenuItem47.Index = 20
        Me.MenuItem47.Text = "Caterer Master"
        '
        'menu_Transaction
        '
        Me.menu_Transaction.Index = 1
        Me.menu_Transaction.MenuItems.AddRange(New System.Windows.Forms.MenuItem() {Me.submnu_PODdetails, Me.MenuItem34, Me.MenuItem31, Me.MenuItem35, Me.MenuItem11, Me.MenuItem29, Me.MenuItem27, Me.submnu_StatusConversion, Me.MenuItem43, Me.MenuItem44})
        ...
        Me.MenuItem35.Text = "Banquet Final Billing"
        '
        'MenuItem11
        '
        ...
        Me.submnu_StatusConversion.Text = "Banquet Cancellation"
        '
        'MenuItem43
        '
        Me.MenuItem43.Index = 8
        Me.MenuItem43.Text = "Banquet Kot Entry"
        Me.MenuItem43.Visible = False
        '
        'MenuItem44
        '
        Me.MenuItem44.Index = 9
        Me.MenuItem44.Text = "Outside Item Purchase "
        Me.MenuItem44.Visible = False
        '
        'MenuItem4
        '
        Me.MenuItem4.Index = 2
        Me.MenuItem4.MenuItems.AddRange(New System.Windows.Forms.MenuItem() {Me.MenuItem8, Me.MenuItem9, Me.MenuItem39, Me.MenuItem38, Me.MenuItem7, Me.MenuItem23, Me.MenuItem10, Me.MenuItem2, Me.MenuItem1, Me.MenuItem12, Me.MenuItem13, Me.MenuItem5, Me.MenuItem28, Me.MenuItem30, Me.MenuItem37, Me.MenuItem40, Me.MenuItem48})
        ...
        Me.MenuItem48.Text = "Banquet Tax Report"
        '
        'MenuItem14
        '
...
#End Region
            ...
            For i = 0 To gdataset.Tables("user").Rows.Count - 1
                With gdataset.Tables("user").Rows(i)
                    If Trim(.Item("mainmoduleid") & "") <> "" And Trim(.Item("submoduleid") & "") <> "" And Trim(.Item("ssubmoduleid") & "") <> "" Then
                        k = Val(gdataset.Tables("user").Rows(i).Item("mainmoduleid"))
                        j = Val(gdataset.Tables("user").Rows(i).Item("submoduleid"))
                        x = Val(gdataset.Tables("user").Rows(i).Item("ssubmoduleid"))

                        MainMenu1.MenuItems(k).MenuItems(j).MenuItems(x).Enabled = True

                        ' MainMenu1.MenuItems(Val(gdataset.Tables("user").Rows(i).Item("mainmoduleid"))).MenuItems(Val(gdataset.Tables("user").Rows(i).Item("submoduleid"))).MenuItems(Val(gdataset.Tables("user").Rows(i).Item("ssubmoduleid"))).Enabled = True
                        chstr = abcdMINUS(.Item("rights"))
                    ElseIf Trim(.Item("mainmoduleid") & "") <> "" And Trim(.Item("submoduleid") & "") <> "" Then
                        k = Val(.Item("mainmoduleid"))
                        j = Val(.Item("submoduleid"))
                        MainMenu1.MenuItems(k).MenuItems(j).Enabled = True

                        'MainMenu1.MenuItems(Val(.Item("mainmoduleid"))).MenuItems(Val(.Item("submoduleid"))).Enabled = True
                        chstr = abcdMINUS(.Item("rights"))
                    ElseIf Trim(.Item("mainmoduleid") & "") <> "" Then
                        k = Val(.Item("mainmoduleid"))
                        MainMenu1.MenuItems(k).Enabled = True
    ...
    Private Sub PartyMDI_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        sqlString = "SELECT ISNULL(COMPNAME,'') AS COMPNAME,Isnull(FloodTaxCode,'') as FloodTaxCode FROM PARTYSETUP "
        ...
        If gdataset.Tables("CNAME").Rows.Count > 0 Then
            ...
            PartyCompanyName = Trim(gdataset.Tables("CNAME").Rows(0).Item("COMPNAME"))
            FloodTaxCode = Trim(gdataset.Tables("CNAME").Rows(0).Item("FloodTaxCode"))
        End If
        ...
        ClubStateCode = gconnection.getvalue("SELECT Isnull(STATECODE,'') as STATECODE FROM MASTER..CLUBMASTER where datafile = '" & gDatabase & "'")
        If ClubStateCode = Nothing Then
            ClubStateCode = "32"
        End If
    ...
    Private Sub Update_Column()
        Dim sqlstring As String
        Try
            sqlstring = "IF NOT EXISTS( SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'party_arrangement_TAX' AND  COLUMN_NAME = 'BOOKINGTYPE') Begin ALTER TABLE party_arrangement_TAX ADD BOOKINGTYPE VARCHAR(20) End"
            gconnection.dataOperation(6, sqlstring, "AddC")
            sqlstring = "IF NOT EXISTS( SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'PARTY_hDR' AND  COLUMN_NAME = 'BILLNO') Begin ALTER TABLE PARTY_hDR ADD BILLNO VARCHAR(20) End"
            gconnection.dataOperation(6, sqlstring, "AddC")
            sqlstring = "IF NOT EXISTS( SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'PARTY_hDR' AND  COLUMN_NAME = 'BILLDATE') Begin ALTER TABLE PARTY_hDR ADD BILLDATE DATETIME End"
            gconnection.dataOperation(6, sqlstring, "AddC")

            sqlstring = "IF NOT EXISTS( SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'party_hallbooking_hdr' AND  COLUMN_NAME = 'MEMGSTNO') Begin ALTER TABLE party_hallbooking_hdr ADD MEMGSTNO VARCHAR(30) End"
            gconnection.dataOperation(6, sqlstring, "AddC")

            sqlstring = "IF NOT EXISTS( SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'party_hallbooking_hdr' AND  COLUMN_NAME = 'STCODE') Begin ALTER TABLE party_hallbooking_hdr ADD STCODE VARCHAR(5) End"
            gconnection.dataOperation(6, sqlstring, "AddC")

            sqlstring = "IF NOT EXISTS( SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'party_hallbooking_hdr' AND  COLUMN_NAME = 'STCODE') Begin ALTER TABLE party_hallbooking_hdr ADD STCODE VARCHAR(5) End"
            gconnection.dataOperation(6, sqlstring, "AddC")

            sqlstring = "IF NOT EXISTS( SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'PARTYSETUP' AND  COLUMN_NAME = 'FloodTaxCode') Begin ALTER TABLE PARTYSETUP ADD FloodTaxCode VARCHAR(10) End"
            gconnection.dataOperation(6, sqlstring, "AddC")

            sqlstring = "IF NOT EXISTS( SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'party_hallbooking_hdr' AND  COLUMN_NAME = 'FTaxApply') Begin ALTER TABLE party_hallbooking_hdr ADD FTaxApply VARCHAR(3) End"
            gconnection.dataOperation(6, sqlstring, "AddC")
    ...
    Public Sub Status_Update()
        Dim LStr As String
        Dim i As Integer
        sqlString = "SELECT * FROM PARTY_HALLBOOKING_HDR WHERE ISNULL(Status_Type,'') = 'PROVISIONAL'"
        gconnection.getDataSet(sqlString, "Status")
        If gdataset.Tables("Status").Rows.Count > 0 Then
            For i = 0 To gdataset.Tables("Status").Rows.Count - 1
                Dim DT As New DataTable
                sqlString = "SELECT * from partyrec_advance WHERE bookno='" & gdataset.Tables("Status").Rows(i).Item("BOOKINGNO") & "'"
                DT = gconnection.GetValues(sqlString)
                If DT.Rows.Count > 0 Then
                    LStr = "UPDATE PARTY_HALLBOOKING_HDR SET Status_Type = 'CONFIRMED' WHERE BOOKINGNO = '" & gdataset.Tables("Status").Rows(i).Item("BOOKINGNO") & "' "
                    gconnection.dataOperation(10, LStr, "Confirm")
                Else
                End If
            Next
    ...
    Public Sub Log_User()
        ...
        LStr = LStr & "VALUES('" & gUsername & "','" & Format(Now(), "dd-MMM-yyyy") & "','" & Format(Now(), "T") & "','BANQUET','LOGIN')"
        gconnection.dataOperation(6, LStr, "LOGING")
        LStr = "UPDATE PARTY_HALLBOOKING_HDR SET Status_Type = 'CONFIRMED' WHERE BOOKINGNO IN (SELECT BOOKNO FROM partyrec_advance) and ISNULL(Status_Type,'') In ('PROVISIONAL','CONFIRED')"
        gconnection.dataOperation(6, LStr, "Confirm")
    End Sub
    Public Sub LogOut_User()
        Dim LStr As String
        LStr = "INSERT INTO LOGING_USER(USERNAME,LOGDATE,LOGTIME,MODULE,TYPE)"
        LStr = LStr & "VALUES('" & gUsername & "','" & Format(Now(), "dd-MMM-yyyy") & "','" & Format(Now(), "T") & "','BANQUET','LOGOUT')"
        gconnection.dataOperation(6, LStr, "LOGING")
    End Sub
    ...
    Private Sub submnu_StatusConversion_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles submnu_StatusConversion.Click
        ...
        GmoduleName = "Banquet Cancellation"
    ...
    Private Sub submnu_MemberCorporate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles submnu_MemberCorporate.Click
        'Dim objgroupmst As New PTY_SUBGROUPMASTER
        Dim objgroupmst As New FRM_MKGA_Subgroupmaster
    ...
    Private Sub submenu_uommaster_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles submenu_uommaster.Click
        ' Dim objuommst As New party_UOMMaster
        Dim objuommst As New FRM_MKGA_Uommaster
    ...
    Private Sub MenuItem19_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MenuItem19.Click
        ...
        ' Dim objitemwisesale As New PTY_GROUPMASTER
        Dim objitemwisesale As New FRM_MKGA_GroupMaster
        objitemwisesale.Show()
        objitemwisesale.MdiParent = Me
    ...
    Private Sub MenuItem22_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MenuItem22.Click
        GmoduleName = "Banquet Cancellation Master"
    ...
    Private Sub MenuItem44_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MenuItem44.Click
        GmoduleName = "Outside Item Purchase "
        Dim objitemwisesale As New NonProductPurchase
        objitemwisesale.Show()
        objitemwisesale.MdiParent = Me
    ...
    Private Sub MenuItem43_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MenuItem43.Click
        GmoduleName = "Banquet Kot Entry"
        Dim objitemwisesale As New Smartkotentry
        objitemwisesale.Show()
        objitemwisesale.MdiParent = Me
    ...
    Private Sub MenuItem41_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MenuItem41.Click
        GmoduleName = "BAnquet Setup "
        Dim objitemwisesale As New PARTYSETUP
        objitemwisesale.Show()
        objitemwisesale.MdiParent = Me
    ...
    Private Sub MenuItem42_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MenuItem42.Click
        GmoduleName = "Banquet Tax Type Master"
        Dim objitemwisesale As New FRM_MKGA_ItemType
        objitemwisesale.Show()
        objitemwisesale.MdiParent = Me
    ...
    Private Sub MenuItem45_Click_1(sender As Object, e As EventArgs) Handles MenuItem45.Click
        GmoduleName = "Banquet Holiday Master"
        Dim objitemwisesale As New FRM_MKGA_HolidayMaster
        objitemwisesale.Show()
        objitemwisesale.MdiParent = Me
    ...
    Private Sub MenuItem46_Click(sender As Object, e As EventArgs) Handles MenuItem46.Click
        GmoduleName = "Banquet Purpose Master"
        Dim objitemwisesale As New FRM_MKGA_Purpose
        objitemwisesale.Show()
        objitemwisesale.MdiParent = Me
    ...
    Private Sub MenuItem47_Click(sender As Object, e As EventArgs) Handles MenuItem47.Click
        GmoduleName = "Caterer Master"
        Dim objitemwisesale As New FRM_MKGA_CATERER
        objitemwisesale.Show()
        objitemwisesale.MdiParent = Me
    ...
    Private Sub MenuItem48_Click(sender As Object, e As EventArgs) Handles MenuItem48.Click
        GmoduleName = "Banquet Tax Report"
        Dim objparty As New TaxReport
        objparty.Show()
        objparty.MdiParent = Me
