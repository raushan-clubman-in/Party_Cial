...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(BILLPENDING))
        ...
        Me.CMBBOOKINGTYPE.Items.AddRange(New Object() {"BOOKING", "BILLING"})
        Me.CMBBOOKINGTYPE.Location = New System.Drawing.Point(264, 56)
        Me.CMBBOOKINGTYPE.Name = "CMBBOOKINGTYPE"
        Me.CMBBOOKINGTYPE.Size = New System.Drawing.Size(439, 28)
        ...
        Me.CHBCANCEL.Location = New System.Drawing.Point(264, 395)
        ...
        Me.GroupBox3.Location = New System.Drawing.Point(117, 416)
        ...
        Me.Label5.Location = New System.Drawing.Point(209, 552)
        ...
        Me.GroupBox4.Location = New System.Drawing.Point(115, 488)
        ...
        Me.chklist_Rooms.Location = New System.Drawing.Point(264, 112)
        Me.chklist_Rooms.Name = "chklist_Rooms"
        Me.chklist_Rooms.Size = New System.Drawing.Size(440, 277)
        Me.chklist_Rooms.TabIndex = 2
        '
        'Chk_roomselection
        '
...
#End Region
    ...
    End Sub
    Private Sub BILLPENDING_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub Hallstatus()
        Try
            ...
            Dim sqlstring As String
            sqlstring = ""
            sqlstring = "SELECT BOOKINGNO,HALLAMOUNT,ARRMENTAMOUNT,RESTAMOUNT,BOOKINGDATE,HALLCODE,HALLDESCRIPTION,PARTYDATE,MCODE,MNAME,ASSOCIATENAME,BILLINGFLAG,BOOKINGFLAG,FREEZE FROM VIEW_PARTY_BOOKINGPENDING "
            ...
            If Trim(CMBBOOKINGTYPE.Text) = "BILLING" Then
                sqlstring = sqlstring & " AND BILLINGFLAG='Y' AND BOOKINGTYPE='" & CMBBOOKINGTYPE.Text & "'"
            Else
                sqlstring = sqlstring & " AND BOOKINGFLAG='Y' AND BOOKINGTYPE='" & CMBBOOKINGTYPE.Text & "'"
            End If
            ...
            heading(0) = Trim(CMBBOOKINGTYPE.Text) & " - PENDING"
            Dim ObjBillregister As New HallPending
            ObjBillregister.BOOKINGDETAILS(heading, sqlstring, Dtpbookfromdate.Value, dtpbooktodate.Value)
    ...
    Private Sub Chk_roomselection_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Chk_roomselection.CheckedChanged
        ...
        End If
    End Sub
    Private Sub BILLPENDING_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        Dim i As Integer
