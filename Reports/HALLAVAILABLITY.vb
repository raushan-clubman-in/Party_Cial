...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.GroupBox4.Size = New System.Drawing.Size(148, 473)
        ...
        Me.cmdexport.Location = New System.Drawing.Point(6, 277)
        ...
        Me.CmdClear.Location = New System.Drawing.Point(7, 44)
        ...
        Me.CmdPrint.Location = New System.Drawing.Point(7, 199)
        ...
        Me.cmdexit.Location = New System.Drawing.Point(8, 354)
        ...
        Me.CmdView.Location = New System.Drawing.Point(7, 124)
        ...
        Me.Chk_roomselection.Location = New System.Drawing.Point(181, 102)
        ...
        Me.GroupBox3.Location = New System.Drawing.Point(186, 477)
        Me.GroupBox3.Name = "GroupBox3"
        Me.GroupBox3.Size = New System.Drawing.Size(592, 64)
        ...
        Me.Dtpbookfromdate.Location = New System.Drawing.Point(155, 20)
        ...
        Me.Label6.Location = New System.Drawing.Point(334, 23)
        ...
        Me.dtpbooktodate.Location = New System.Drawing.Point(430, 21)
        ...
        Me.chklist_Rooms.Location = New System.Drawing.Point(181, 132)
...
#End Region
    Private Sub CmdView_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CmdView.Click
        ...
        gPrint = False
        Call Hall_Status1()
        '  If MsgBox("DOS PrintOut", MsgBoxStyle.YesNo, "Laser") = MsgBoxResult.Yes Then
        ' Call print_windows()
        Call HallView()
        'Else
        '    Call HallView()
                            ...
                            If dt.Rows.Count > 0 Then
                                ...
                                For j = 0 To dt.Rows.Count - 1
                                    For k = Val(dt.Rows(j).Item("fromtime")) To Val(dt.Rows(j).Item("totime"))
                                        ...
                                        ssql = " Update PARTY_HallStatus set b" & Trim(k + 1) & "='P'"
                            ...
                            If dt.Rows.Count > 0 Then
                                ...
                                If DT3.Rows.Count > 0 Then
                                    For j = 0 To dt.Rows.Count - 1
                                        For k = Val(dt.Rows(j).Item("fromtime")) To Val(dt.Rows(j).Item("totime"))
                                            'ssql = " Update PARTY_HallStatus set b" & Trim(k) & "='C'"
                                            ssql = " Update PARTY_HallStatus set b" & Trim(k + 1) & "='C'"
                                            ssql = ssql & " Where Bookingdate='" & Format(dd, "dd/MMM/yyyy") & "'"
                                            ssql = ssql & " and hallcode='" & hallcode & "'"
    ...
    Private Sub Hall_Status()
        ...
        Try
            ...
            Dim hallcode, PCODE, tspilt() As String
    ...
    Public Function Reportdetails(ByVal SQLSTRING As String, ByVal columnheading() As String, ByVal mskfromdate As Date, ByVal msktodate As Date)
        ...
        Try
            ...
            If gdataset.Tables("CREDITSALEREGISTER").Rows.Count > 0 Then
                ...
                pagesize = pagesize + 1
                Filewrite.WriteLine("Note : " & "P --> Provisional Booked")
                pagesize = pagesize + 1
    ...
    Private Sub HALLAVAILABLITY_Resize(sender As Object, e As EventArgs) Handles Me.Resize
        rs.ResizeAllControls(Me)
    End Sub
End Class
