...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(ITEMWISESALES))
        ...
        Me.Label3.Size = New System.Drawing.Size(427, 31)
        Me.Label3.TabIndex = 424
        Me.Label3.Text = "BANQUET SALES LOCATION WISE"
        '
        'Chk_roomselection
        '
        ...
        Me.Button2.Location = New System.Drawing.Point(576, 584)
        ...
        Me.Button3.Location = New System.Drawing.Point(712, 584)
        ...
        Me.KeyPreview = True
        Me.Name = "ITEMWISESALES"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "BANQUET SALES LOCATION WISE"
...
#End Region
    ...
    Private Sub FillhallLocation()
        ...
        sqlstring = "SELECT DISTINCT POS,POSDESC  FROM VIEW_PARTY_ITEMWISE "
        ...
        If gdataset.Tables("HALL").Rows.Count - 1 >= 0 Then
            For i = 0 To gdataset.Tables("HALL").Rows.Count - 1
                With gdataset.Tables("HALL").Rows(i)
                    chklist_Rooms.Items.Add(.Item("POS") & "-->" & .Item("POSDESC"))
                End With
            Next i
        End If
    ...
    Private Sub ITEMWISESALES()
        ...
        Viewer.Report = r1
        Viewer.TableName = "VIEW_PARTY_ITEMWISE"
        ...
        TXTOBJ1 = r1.ReportDefinition.ReportObjects("Text20")
    ...
    Private Sub dtpbooktodate_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles dtpbooktodate.KeyPress
        ...
        End If
    End Sub
    Private Sub CHBCANCEL_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Asc(e.KeyChar) = Keys.Enter Then
            Dtpbookfromdate.Focus()
        End If
    End Sub
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        _export.TABLENAME = "VIEW_PARTY_ITEMWISE"
        sqlstring = "select distinct from VIEW_PARTY_ITEMWISE "
        Call _export.export_excel(sqlstring)
        _export.Show()
        Exit Sub
    End Sub

    Private Sub CHBCANCEL_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
