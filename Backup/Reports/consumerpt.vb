...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(consumerpt))
        ...
        'CMD_BOOKTO
        '
        Me.CMD_BOOKTO.BackColor = System.Drawing.Color.Transparent
        Me.CMD_BOOKTO.Font = New System.Drawing.Font("Microsoft Sans Serif", 15.75!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        ...
        'Cmd_BookingNo
        '
        Me.Cmd_BookingNo.BackColor = System.Drawing.SystemColors.Control
        Me.Cmd_BookingNo.Font = New System.Drawing.Font("Microsoft Sans Serif", 8.25!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        ...
        Me.dtpto.Value = New Date(2011, 12, 27, 2, 18, 38, 126)
        '
        'TabControl1
        '
        ...
        Me.TabControl1.ItemSize = New System.Drawing.Size(136, 30)
        ...
        Me.dtpfrom.Value = New Date(2011, 12, 27, 2, 18, 38, 267)
        '
        'Label3
        '
        ...
        Me.Label5.TabIndex = 865
        Me.Label5.Text = "PARTY BOOKINGNO  FROM "
        '
        'Label6
        '
        ...
        Me.Label6.Size = New System.Drawing.Size(231, 23)
        Me.Label6.TabIndex = 866
        Me.Label6.Text = "PARTY  BOOKINGNO TO  "
        '
        'Label7
        '
        ...
        Me.Label7.Text = "PARTY FROM  DATE"
        '
        'Label8
        '
...
#End Region
    ...
    Public Sub Cmd_report_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_report.Click
        Dim i As Integer
        Dim Viewer As New ReportViwer
        ' Dim r As New consum1
        Dim r As New party_barcon
        If Me.TXTBOOKINGNO.Text <> "" Then
            SSQL = " SELECT * FROM PARTY_BAR_CONSUMPTION WHERE cast(BOOKINGNO as integer) BETWEEN '" & Me.TXTBOOKINGNO.Text & "' AND '" & Me.TXTBOKNOTO.Text & "' ORDER BY PARTYDATE,BOOKINGNO"
        Else
            SSQL = " SELECT * FROM PARTY_BAR_CONSUMPTION WHERE partydate BETWEEN '" & Format(Me.dtpfrom.Value, "dd-MMM-yyyy") & "' AND '" & Format(Me.dtpto.Value, "dd-MMM-yyyy") & "' ORDER BY PARTYDATE,BOOKINGNO"

        End If

        Viewer.Report = r
        
        Call Viewer.GetDetails(SSQL, "PARTY_BAR_CONSUMPTION", r)

        Viewer.TableName = "PARTY_BAR_CONSUMPTION"
    ...
    Private Sub consumerpt_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub TXTBOKNOTO_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TXTBOKNOTO.TextChanged
