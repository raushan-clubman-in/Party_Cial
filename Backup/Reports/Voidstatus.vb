...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(Voidstatus))
        ...
        Me.GroupBox4.Location = New System.Drawing.Point(144, 568)
        Me.GroupBox4.Name = "GroupBox4"
        Me.GroupBox4.Size = New System.Drawing.Size(720, 56)
        ...
        Me.CmdClear.Location = New System.Drawing.Point(16, 15)
        ...
        Me.CmdPrint.Location = New System.Drawing.Point(288, 15)
        ...
        Me.cmdexit.Location = New System.Drawing.Point(584, 15)
        ...
        Me.cmdreport.Location = New System.Drawing.Point(816, 400)
        ...
        Me.Label3.Text = "HALL CANCEL REPORT"
        '
        'Chk_roomselection
        '
...
#End Region
    Private Sub GetRights()
        ...
        End If
    End Sub
    Private Sub Voidstatus_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub print_windows()
        ...
        Dim r As New RPT_VOID_REGISTER1
        ...
        sqlstring = "SELECT * FROM BANQUETFREEZEREPORT WHERE"
        ...
        sqlstring = sqlstring & " ORDER BY HALLCODE,PARTYDATE,BOOKINGNO"
        ...
        Viewer.Report = r
        Viewer.TableName = "BANQUETFREEZEREPORT"

        'Viewer.ssql = sqlstring

        'Viewer.Report = r
        'Viewer.TableName = "VIEW_PARTY_BOOKINGDETAILS1"

        Dim textobj1 As TextObject
        textobj1 = r.ReportDefinition.ReportObjects("Text11")
        textobj1.Text = MyCompanyName
        Dim TXTOBJ2 As TextObject
        TXTOBJ2 = r.ReportDefinition.ReportObjects("Text19")
        TXTOBJ2.Text = gUsername
        Dim TXTOBJ3 As TextObject

        TXTOBJ3 = r.ReportDefinition.ReportObjects("Text22")
    ...
    Private Sub CmdPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CmdPrint.Click
        ...
        Call print_windows()
    End Sub
    Private Sub Voidstatus_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        Dim i As Integer
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        exp.Show()
        Call exp.export(sqlstring, "BANQUET VOID REPORT DETAILS " & Format(Dtpbookfromdate.Value, "dd-MMM-yyyy") & "TO" & Format(dtpbooktodate.Value, "dd-MMM-yyyy"), "")
