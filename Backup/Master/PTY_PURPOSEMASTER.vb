...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(PTY_PURPOSEMASTER))
        ...
        Me.lbl_freeze.Location = New System.Drawing.Point(352, 416)
        ...
        Me.cmd_Freeze.Location = New System.Drawing.Point(336, 16)
        ...
        Me.grp_StatusConversion4.Location = New System.Drawing.Point(136, 448)
        Me.grp_StatusConversion4.Name = "grp_StatusConversion4"
        Me.grp_StatusConversion4.Size = New System.Drawing.Size(752, 64)
        ...
        Me.CMD_PRINT.Location = New System.Drawing.Point(760, 168)
        ...
        Me.cmd_View.Location = New System.Drawing.Point(616, 200)
        ...
        'CMD_Pcode
        '
        Me.CMD_Pcode.BackColor = System.Drawing.Color.FromArgb(CType(192, Byte), CType(192, Byte), CType(255, Byte))
        Me.CMD_Pcode.Image = CType(resources.GetObject("CMD_Pcode.Image"), System.Drawing.Image)
        Me.CMD_Pcode.Location = New System.Drawing.Point(264, 16)
        Me.CMD_Pcode.Name = "CMD_Pcode"
        Me.CMD_Pcode.Size = New System.Drawing.Size(24, 24)
        Me.CMD_Pcode.TabIndex = 428
        '
        'Label14
        '
        ...
        Me.lbl_Caption.Location = New System.Drawing.Point(320, 120)
        Me.lbl_Caption.Name = "lbl_Caption"
        Me.lbl_Caption.Size = New System.Drawing.Size(236, 31)
        Me.lbl_Caption.TabIndex = 425
        Me.lbl_Caption.Text = "SESSION  MASTER"
        ...
        Me.GroupBox1.Location = New System.Drawing.Point(200, 192)
        ...
        Me.Txt_totime1.CausesValidation = CType(configurationAppSettings.GetValue("Txt_totime.CausesValidation", GetType(System.Boolean)), Boolean)
        ...
        Me.Grp_Print.Location = New System.Drawing.Point(304, 384)
        ...
        Me.CMD_DOS.Location = New System.Drawing.Point(104, 272)
...
#End Region
    ...
    Private Sub checkvalidate()
        ...
        If Trim(txt_PCode.Text) = "" Then
            MessageBox.Show("Purpose Code Can't be blank", MyCompanyName, MessageBoxButtons.OK, MessageBoxIcon.Exclamation, MessageBoxDefaultButton.Button1)
            txt_PCode.Focus()
            Exit Sub
        End If
        If Trim(Txt_PDesc.Text) = "" Then
            MessageBox.Show("Purpose Description Can't be blank", MyCompanyName, MessageBoxButtons.OK, MessageBoxIcon.Exclamation, MessageBoxDefaultButton.Button1)
            Txt_PDesc.Focus()
            Exit Sub
        End If
    ...
    Private Sub Cmd_Pcode_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CMD_Pcode.Click
        ...
        gSQLString = "SELECT isnull(PDESC,'') as PDESC,isnull(PCODE,'') as PCODE FROM PARTY_PURPOSEMASTER"
        M_WhereCondition = " "
        vform.Field = "PDESC,PCODE"
        vform.vFormatstring = "        Purpose Description    |     Purpose Code    "
        vform.vCaption = "Purpose Master Help"
        vform.KeyPos = 0
        vform.KeyPos1 = 1
        vform.ShowDialog(Me)
        If Trim(vform.keyfield & "") <> "" Then
            txt_PCode.Text = Trim(vform.keyfield1 & "")
    ...
    Private Sub txt_Pcode_Validated(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txt_PCode.Validated
        If Trim(txt_PCode.Text) <> "" Then
            sqlstring = "SELECT ISNULL(PCODE,'')AS PCODE,ISNULL(PDESC,'')AS PDESC,isnull(FROMTIME,'')AS FROMTIME,ISNULL(TOTIME,'')AS TOTIME,isNull(freeze,'')as freeze FROM PARTY_PURPOSEMASTER"
    ...
    Private Sub Txt_PDesc_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Txt_PDesc.KeyPress
        ...
        End If
    End Sub
    Private Sub Txt_Fromtime_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Txt_Fromtime1.KeyPress
        getNumeric(e)
        If Asc(e.KeyChar) = 13 Then
            If Trim(Txt_Fromtime.Text) <> "" Then
                Txt_totime.Focus()
        ...
        End If
    End Sub
    Private Sub Txt_totime_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Txt_totime1.KeyPress
        getNumeric(e)
        If Asc(e.KeyChar) = 13 Then
            If Trim(Txt_totime.Text) <> "" Then
                cmd_Add.Focus()
    ...
    Private Sub Txt_Fromtime_KeyPress1(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Txt_Fromtime.KeyPress
        getNumeric(e)
        If Asc(e.KeyChar) = 13 Then
            If Trim(Txt_Fromtime.Text) <> "" Then
                Txt_totime.Focus()
    ...
    Private Sub Txt_totime_KeyPress1(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Txt_totime.KeyPress
        getNumeric(e)
        If Asc(e.KeyChar) = 13 Then
            If Trim(Txt_totime.Text) <> "" Then
                cmd_Add.Focus()
