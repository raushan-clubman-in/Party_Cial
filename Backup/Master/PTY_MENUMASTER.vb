...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(PTY_MENUMASTER))
        ...
        Me.cmd_Exit.Location = New System.Drawing.Point(560, 16)
        ...
        Me.grp_StatusConversion4.Size = New System.Drawing.Size(696, 64)
        ...
        Me.cmd_print.Location = New System.Drawing.Point(776, 304)
        ...
        Me.cmd_View.Location = New System.Drawing.Point(664, 304)
        ...
        Me.CMD_Menucode.Location = New System.Drawing.Point(256, 16)
        ...
        Me.txt_MenuCode.Size = New System.Drawing.Size(56, 21)
        ...
        Me.lbl_Caption.Location = New System.Drawing.Point(376, 184)
        Me.lbl_Caption.Name = "lbl_Caption"
        Me.lbl_Caption.Size = New System.Drawing.Size(217, 31)
        ...
        Me.GroupBox1.Location = New System.Drawing.Point(216, 280)
...
#End Region
    ...
    Private Sub txt_menucode_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txt_MenuCode.KeyPress
        ...
        End If
    End Sub
    Private Sub txt_menucode_Validated(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txt_MenuCode.Validated
        If Trim(txt_MenuCode.Text) <> "" Then
            sqlstring = "SELECT ISNULL(MENUCODE,'')AS MENUCODE,ISNULL(MENUDESC,'')AS MENUDESC,ISNULL(FREEZE,'')AS FREEZE FROM PARTY_MENU_MASTER"
            ...
            If gdataset.Tables("GRP").Rows.Count > 0 Then
                cmd_Add.Text = "Update[F7]"
                txt_MenuCode.Text = gdataset.Tables("GRP").Rows(0).Item("MENUCODE")
                Txt_Menudesc.Text = gdataset.Tables("GRP").Rows(0).Item("MENUDESC")
    ...
    Private Sub cmd_Add_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_Add.Click
        ...
        If Mid(cmd_Add.Text, 1, 1) = "A" Then
            sqlstring = "INSERT INTO PARTY_MENU_MASTER (menucode,menudesc,freeze,adduser,adddate) VALUES("
            sqlstring = sqlstring & " '" & Trim(txt_MenuCode.Text) & "','" & Trim(Txt_Menudesc.Text) & "','N',"
        ...
        ElseIf Mid(cmd_Add.Text, 1, 1) = "U" Then
            If lbl_freeze.Visible = True Then
                ...
                Exit Sub
            End If
            sqlstring = "UPDATE PARTY_MENU_MASTER SET MENUDESC='" & Trim(Txt_Menudesc.Text) & "',FREEZE='N',"
    ...
    Private Sub cmd_Freeze_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_Freeze.Click
        ...
        If Mid(cmd_Freeze.Text, 1, 1) = "F" Then
            sqlstring = "SELECT ISNULL(MENUCODE,'')AS MENUCODE,ISNULL(MENUDESC,'')AS MENUDESC FROM PARTY_MENU_MASTER"
            sqlstring = sqlstring & " WHERE ISNULL(MENUCODE,'')='" & Trim(txt_MenuCode.Text) & "'"
            gconn.getDataSet(sqlstring, "GRP1")
            If gdataset.Tables("GRP1").Rows.Count > 0 Then
                sqlstring = "UPDATE PARTY_MENU_MASTER SET FREEZE='Y',"
                sqlstring = sqlstring & " ADDUSER='" & Trim(gUsername) & "',ADDDATE='" & Format(DateTime.Now, "dd/MMM/yyyy") & "' "
                sqlstring = sqlstring & " WHERE MENUCODE='" & Trim(txt_MenuCode.Text) & "'"
        ...
        If Mid(cmd_Freeze.Text, 1, 1) = "U" Then
            sqlstring = "UPDATE PARTY_MENU_MASTER SET FREEZE='N',"
            sqlstring = sqlstring & " ADDUSER='" & Trim(gUsername) & "',ADDDATE='" & Format(DateTime.Now, "dd/MMM/yyyy") & "' "
            sqlstring = sqlstring & " WHERE MENUCODE='" & Trim(txt_MenuCode.Text) & "'"
    ...
    Private Sub cmd_View_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_View.Click
        ...
        'tables = " FROM PARTY_MENU_MASTER"
        'Gheader = "MENU MASTER"
        'FrReport.SsGridReport.SetText(2, 1, "MENUCODE")
        'FrReport.SsGridReport.SetText(3, 1, 10)
        'FrReport.SsGridReport.SetText(2, 2, "MENUDESC")
