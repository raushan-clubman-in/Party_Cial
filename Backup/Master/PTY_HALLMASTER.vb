...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(PTY_HALLMASTER))
        ...
        Me.GroupBox1.Size = New System.Drawing.Size(656, 208)
        ...
        Me.txt_feau.Location = New System.Drawing.Point(144, 168)
        Me.txt_feau.MaxLength = 50
        Me.txt_feau.Name = "txt_feau"
        Me.txt_feau.Size = New System.Drawing.Size(192, 21)
        Me.txt_feau.TabIndex = 11
        Me.txt_feau.Text = ""
        '
        'Label13
        '
        ...
        Me.CMD_GLACCODE.Location = New System.Drawing.Point(528, 136)
        ...
        Me.TXT_GLACCODE.Location = New System.Drawing.Point(448, 136)
        ...
        Me.Label11.Location = New System.Drawing.Point(288, 136)
        ...
        Me.Txt_Rate.Location = New System.Drawing.Point(448, 96)
        ...
        Me.Txt_MaxCapacity.Location = New System.Drawing.Point(448, 56)
        ...
        Me.Txt_Mincapacity.Location = New System.Drawing.Point(144, 96)
        Me.Txt_Mincapacity.MaxLength = 5
        Me.Txt_Mincapacity.Name = "Txt_Mincapacity"
        Me.Txt_Mincapacity.Size = New System.Drawing.Size(64, 21)
        Me.Txt_Mincapacity.TabIndex = 6
        ...
        Me.Txt_HallTypedesc.Location = New System.Drawing.Point(448, 16)
        ...
        Me.Txt_HallTypedesc.TabIndex = 3
        ...
        Me.SSGRID.Location = New System.Drawing.Point(32, 312)
        Me.SSGRID.Name = "SSGRID"
        Me.SSGRID.OcxState = CType(resources.GetObject("SSGRID.OcxState"), System.Windows.Forms.AxHost.State)
        Me.SSGRID.Size = New System.Drawing.Size(896, 192)
        Me.SSGRID.TabIndex = 12
        '
        'lbl_freeze
        '
        ...
        Me.lbl_freeze.Location = New System.Drawing.Point(328, 280)
        ...
        Me.cmd_Exit.Location = New System.Drawing.Point(768, 576)
        ...
        Me.CMD_WINDOWS.BackgroundImage = CType(resources.GetObject("CMD_WINDOWS.BackgroundImage"), System.Drawing.Image)
        ...
        'LST_TAX
        '
        Me.LST_TAX.Location = New System.Drawing.Point(704, 72)
        Me.LST_TAX.Name = "LST_TAX"
        Me.LST_TAX.Size = New System.Drawing.Size(224, 199)
        ...
        Me.Label17.Location = New System.Drawing.Point(704, 40)
...
#End Region
            ...
            If gdataset.Tables("HALL").Rows.Count > 0 Then
                ...
                With SSGRID
                    For i = 0 To gdataset.Tables("HALL").Rows.Count - 1
                        ...
                        ' .Text = Format(CDate(gdataset.Tables("HALL").Rows(0).Item("FROMTIME")), " HH:mm")
                        .Text = gdataset.Tables("HALL").Rows(i).Item("FROMTIME")
                        .Col = 4
                        .Row = i + 1
                        ' .Lock = True

                        '.Text = Format(CDate(gdataset.Tables("HALL").Rows(0).Item("TOTIME")), " HH:mm")
    ...
    Private Sub cmd_Add_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_Add.Click
        ...
        If Mid(cmd_Add.Text, 1, 1) = "A" Then
            '************************HDR INSERTION******************************
            sqlstring = "INSERT INTO PARTY_HALLMASTER_HDR (halltypecode,halltypedesc,loccode,locdesc,mincapacity,maxcapacity,actcapacity,rate,taxtype,"
            ...
            sqlstring = sqlstring & " " & Val(Txt_ActCapacity.Text) & "," & Val(Txt_Rate.Text) & ",'" & Trim(Txt_taxtype.Text) & "',"
        ...
        ElseIf Mid(cmd_Add.Text, 1, 1) = "U" Then
            ...
            If gdataset.Tables("HALLVIEW").Rows.Count > 0 Then
                ...
                sqlstring = sqlstring & " MENUHEADRATE=" & Val(Txt_menuhead.Text) & ",RATE=" & Val(Txt_Rate.Text) & ","
